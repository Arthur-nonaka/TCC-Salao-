          ...
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item ">
              <Link
                ...
                style={
                  currentLocation.pathname === "/beautyflow/schedule"
                    ? { color: "#F2F2F2", backgroundColor: "#E68AA5" }
                    : { color: "black" }
                }
                to="schedule"
                state={{ email }}
            ...
            <li className="nav-item ">
              <Link
                className="nav-link p-3"
                style={
                  currentLocation.pathname === "/beautyflow/clients"
                    ? { color: "#F2F2F2", backgroundColor: "#E68AA5" }
                    : { color: "black" }
                }
                to="clients"
            ...
            <li className="nav-item ">
              <Link
                className="nav-link p-3"
                style={
                  currentLocation.pathname === "/beautyflow/products"
                    ? { color: "#F2F2F2", backgroundColor: "#E68AA5" }
                    : { color: "black" }
                }
                to="products"
            ...
            <li className="nav-item ">
              <Link
                className="nav-link p-3"
                style={
                  currentLocation.pathname === "/beautyflow/services"
                    ? { color: "#F2F2F2", backgroundColor: "#E68AA5" }
                    : { color: "black" }
                }
                to="services"
            ...
            <li className="nav-item ">
              <Link
                className="nav-link p-3"
                style={
                  currentLocation.pathname === "/beautyflow/expenses"
                    ? { color: "#F2F2F2", backgroundColor: "#E68AA5" }
                    : { color: "black" }
                }
                to="expenses"
