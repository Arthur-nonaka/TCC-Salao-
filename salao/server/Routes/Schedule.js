const { getSchedule, getScheduleAccordion, deleteSchedule, registerSchedule, verifyScheduleTime, verifyScheduleEqual } = require('../Query.js');
...
function AddScheduleRoutes(app) {
    ...
    app.post("/register/Agenda", async (req, res) => {
        try {
            ...
            if (isPossible) {
                await registerSchedule(dateTime, dateTimeEnd, email, clientSelected, servicesSelected)
